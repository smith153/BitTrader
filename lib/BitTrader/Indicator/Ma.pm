...
has 'avg' => (	is => 'ro', isa => 'Math::Ewa',
		builder => sub {return Math::Ewa->new(alpha => 1/8)},
);
has 'avg_slow' => (	is => 'ro', isa => 'Math::Ewa',
		builder => sub {return Math::Ewa->new(alpha => 1/16)},
);
has 'avg_slower' => (	is => 'ro', isa => 'Math::Ewa',
		builder => sub {return Math::Ewa->new(alpha => 1/32)},
);
has 'avg_slowest' => (	is => 'ro', isa => 'Math::Ewa',
		builder => sub {return Math::Ewa->new(alpha => 1/128)},
);
